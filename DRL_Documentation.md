...
### Difficulties in RL
1. <span id="RewardDelay">Reward Delay</span><br>
...
$$P(\tau|\theta) = P(s_1)P(a_1|s_1, \theta)P(r_1, s_2|s_1, a_1)P(a_2|s_2, \theta)... = P(s_1)\prod_{t=1}^T{P(a_t|s_t, \theta)P(r_t, s_{t+1}|s_t, a_t)}$$
...
`Note`: $\gamma$ called discount factor, $\gamma < 1$.<br>
